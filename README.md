...
# 📖 Portfolio-Setup-and-mobile-version-skeleton <a name="about-project"></a>

**Portfolio-Setup-and-mobile-version-skeleton** is a portfoilo website as a beginner Full stack web Developer. Though it is yet a work-in-progress, to show mobile version skeleton
...
```sh
  cd my-folder
  git clone https://github.com/abenezer-addisu/Portfolio-Setup-and-mobile-version-skeleton.git
```
